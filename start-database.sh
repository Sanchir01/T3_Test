...
DB_CONTAINER_NAME="t3-testing-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=t3-testing -d -p 5432:5432 docker.io/postgres
